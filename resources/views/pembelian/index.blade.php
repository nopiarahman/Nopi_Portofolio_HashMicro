...
@section('content')
    <section class="content card" style="padding: 10px 10px 10px 10px ">
        <div class="box">
            <x-alert />
            <div class="container">
                <form action="{{ route('pembelianSimpan') }}" method="POST" enctype="multipart/form-data">
                    <h3> <i class="fas fa-boxes    "></i> Pembelian dari Supplier</h3>
                    <hr>
                    {{ csrf_field() }}
                    <div class="row my-2">
                        <div class="col-6">
                            <label for="tanggalMasuk">Tanggal Masuk</label>
                            <input value="{{ old('tanggalMasuk') }}" name="tanggalMasuk" type="date"
                                class="form-control bg-light my-2" id="tanggalMasuk" required>
                            <label for="barang_id">Nama Barang</label>
                            <select class="cari form-control bg-light my-2" name="barang_id" required></select>
                        ...
                        <div class="col-6">
                            ...
                            <select class="cariSupplier form-control bg-light my-2" name="supplier_id" required></select>
                            {{-- <input type="text" class="form-control @error('objek') is-invalid @enderror" name="objek" value="{{old('objek')}}"> --}}
                            <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>
                            <script type="text/javascript">
                            ...
                            <input value="{{ old('jumlah') }}" name="jumlah" type="number"
                                class="form-control bg-light my-2" id="jumlah" required>
                        </div>
                    </div>
                    <hr>
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-6 my-2">
                            <form action="{{ route('pembelianCetak') }}" method="get" enctype="multipart/form-data">
