...
@section('content')
    <section class="content card" style="padding:10px ">
        <div class="box">
            ...
            <div class="row">
                <div class="col">
                    <h3><i class="fas fa-boxes   m-2 "></i>Daftar Supplier</h3>
                    <hr>
                </div>
            </div>
            {{-- Tambah Data --}}
            <div>
                <div class="col">
                    <a class="btn btn-primary btn-sm " href="{{ url('supplier/tambah') }}" role="button"><i
                        ...
                        <tbody>
                            @forelse($supplier as $s)
                                <tr>
                                    ...
                                    <td>{{ $s->keterangan }}</td>
                                    <td>
                                        <a href="{{ route('supplierEdit', ['id' => $s->id]) }}"
                                            class="btn btn-info btn-sm"><i class="fas fa-pen"></i>Edit</a>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter" data-id="{{ $s->id }}"
                                            data-nama="{{ $s->nama }}"> <i class="fas fa-trash"
