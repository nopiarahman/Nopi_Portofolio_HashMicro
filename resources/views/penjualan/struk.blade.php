...
<body>
    <div class="kembali2" id="kembali">
        <a href="{{ route('penjualan') }}" class="btn btn-primary"> <i class="fa fa-backward" aria-hidden="true"></i>
            Kembali
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="">
                            ...
                            <div class="text-95 text-secondary-d3">
                                @foreach ($barangKeluar->detail()->get() as $p)
                                    ...
                                    <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                        ...
                                        <div class="col-3" style="text-align: center">
                                            <span class="text-150 text-success-d3 opacity-2">
                                                <h5>Rp. {{ number_format($barangKeluar->detail()->sum('total')) }}
                                                </h5>
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <h5 class="text-right">
                                        Rp.{{ number_format($barangKeluar->detail()->sum('total')) }}</h5>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
