...
@section('content')
    <section class="content card" style="padding: 10px 10px 10px 10px ">
        <div class="box">
            ...
            <div>
                <div class="col">
                    <a class="btn btn-primary btn-sm " href="{{ url('/barang/tambah') }}" role="button"><i
                        ...
                        <tbody>
                            @forelse($barang as $b)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="barang/{{ $b->id }}" class="btn btn-info btn-sm"><i
                                                class="fas fa-pen"></i>Edit</a>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter" data-id="{{ $b->id }}"
                                            data-nama="{{ $b->nama }}"> <i class="fas fa-trash"
